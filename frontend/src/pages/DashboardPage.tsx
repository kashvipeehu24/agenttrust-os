...
export const DashboardPage: React.FC<DashboardPageProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Teammate Module Integration Hub */}
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-sm space-y-4">
        <div>
          <h3 className="font-bold text-sm text-white flex items-center gap-2">
            <ShieldCheck className="w-4 h-4 text-cyan-400" />
            Integrated Enterprise Portal Hub
          </h3>
          <p className="text-xs text-slate-400">
            Consolidated portal access across all four teammate security and finance sub-modules.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div 
            ...
            className="p-4 bg-slate-950/60 border border-slate-800/80 hover:border-cyan-500/50 rounded-xl transition-all cursor-pointer group"
          >
            <h4 className="text-xs font-bold text-cyan-400 group-hover:text-cyan-300">1. IDENTITY MODULE</h4>
            <p className="text-[10px] text-slate-400 mt-1">DID, Reputational score profiles, and binding signatures.</p>
            <div className="flex gap-1.5 mt-2.5 flex-wrap">
              <span className="text-[8px] bg-slate-900 text-slate-300 px-1.5 py-0.5 rounded border border-slate-800">Passports</span>
              <span className="text-[8px] bg-slate-900 text-slate-300 px-1.5 py-0.5 rounded border border-slate-800">Skills</span>
              <span className="text-[8px] bg-slate-900 text-slate-300 px-1.5 py-0.5 rounded border border-slate-800">Wallets</span>
            </div>
          </div>
          ...
          <div 
            ...
            className="p-4 bg-slate-950/60 border border-slate-800/80 hover:border-cyan-500/50 rounded-xl transition-all cursor-pointer group"
          >
            <h4 className="text-xs font-bold text-cyan-400 group-hover:text-cyan-300">2. GOVERNANCE MODULE</h4>
            <p className="text-[10px] text-slate-400 mt-1">Threat control panels, policy rules, and kill-switches.</p>
            <div className="flex gap-1.5 mt-2.5 flex-wrap">
              <span className="text-[8px] bg-slate-900 text-slate-300 px-1.5 py-0.5 rounded border border-slate-800">Live feed</span>
              <span className="text-[8px] bg-slate-900 text-slate-300 px-1.5 py-0.5 rounded border border-slate-800">Alerts</span>
              <span className="text-[8px] bg-slate-900 text-slate-300 px-1.5 py-0.5 rounded border border-slate-800">Sandbox</span>
            </div>
          </div>
          ...
          <div 
            ...
            className="p-4 bg-slate-950/60 border border-slate-800/80 hover:border-cyan-500/50 rounded-xl transition-all cursor-pointer group"
          >
            <h4 className="text-xs font-bold text-cyan-400 group-hover:text-cyan-300">3. UNDERWRITING MODULE</h4>
            <p className="text-[10px] text-slate-400 mt-1">Loan risk assessment, limits, and dynamic pricing metrics.</p>
            <div className="flex gap-1.5 mt-2.5 flex-wrap">
              <span className="text-[8px] bg-slate-900 text-slate-300 px-1.5 py-0.5 rounded border border-slate-800">Scoring</span>
              <span className="text-[8px] bg-slate-900 text-slate-300 px-1.5 py-0.5 rounded border border-slate-800">Limits</span>
              <span className="text-[8px] bg-slate-900 text-slate-300 px-1.5 py-0.5 rounded border border-slate-800">Apply</span>
            </div>
          </div>

          <div 
            onClick={() => navigate('/repayment/module')}
            className="p-4 bg-slate-950/60 border border-slate-800/80 hover:border-cyan-500/50 rounded-xl transition-all cursor-pointer group"
          >
            <h4 className="text-xs font-bold text-cyan-400 group-hover:text-cyan-300">4. REPAYMENT MODULE</h4>
            <p className="text-[10px] text-slate-400 mt-1">Treasury cash flows, bot revenue logs, and smart escrows.</p>
            <div className="flex gap-1.5 mt-2.5 flex-wrap">
              <span className="text-[8px] bg-slate-900 text-slate-300 px-1.5 py-0.5 rounded border border-slate-800">Cash Flow</span>
              <span className="text-[8px] bg-slate-900 text-slate-300 px-1.5 py-0.5 rounded border border-slate-800">Forecast</span>
              <span className="text-[8px] bg-slate-900 text-slate-300 px-1.5 py-0.5 rounded border border-slate-800">Escrow</span>
            </div>
          </div>
        </div>
      </div>
